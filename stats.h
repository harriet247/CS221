...
public:
    ...
    int checkHist(PNG & im,int xLoc,int yLoc,int binK);
    double checkLum(int xLoc,int yLoc,double currLum);
    double checkSat(int xLoc,int yLoc,double currSat);
    double checkSumX(int xLoc,int yLoc,double currHueX);
    double checkSumY(int xLoc,int yLoc,double currHueY);
